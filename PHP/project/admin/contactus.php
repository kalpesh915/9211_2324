                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="my-3">
                                        ...
                                        <input type="text" name="contactname" id="contactperson" required class="form-control" value="<?php echo $contactperson; ?>">
                                    </div>
                                    <div class="my-3">
...
<?php
    if(isset($_POST["updateProcess"])){
        ...
        $users->logWriter($email, "Profile Updated first name $fname and last name $lname");
