<?php
    ...
    */ 
    ...
    class AXIS extends RBI{
        public function deposit($amount, $paymentMode = "Cash"){
            echo "<hr> Axis Bank Accept Deposit Amount $amount with $paymentMode";
        }
    ...
    $axisBank = new AXIS();
    $axisBank->deposit(12000);
    $axisBank->deposit(12000, "ATM");
    $axisBank->deposit(12000, "UPI");
    $axisBank->deposit(12000, "Cheque");
